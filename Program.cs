...
builder.Services.AddControllers()
    ...
    {
        // Сущности EF ссылаются друг на друга (AiDraftTest <-> AiDraftTask),
        // без этого сериализация циклических ссылок падала бы с 500.
...
builder.Services.AddScoped<IAITestMakerService, AITestMakerService>();
builder.Services.AddHttpClient<IAIPdfTestClient, OpenRouterRestClient>();
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        // Хранит введённый в Authorize токен в localStorage браузера,
        // чтобы он не пропадал при перезагрузке страницы и рестарте приложения.
